...
//       setpropType(response);
      
//     } catch (err) {
//       setpropTypeError(
//         "Failed to fetch proptype list. Please try again later."
//       );
//       console.error("Error fetching proptype list:", err);
//     } finally {
...
//     const fieldValues = [
//       1, // Example value for user_id
//       formData.propType || null, 
//       formData.homeType || null,
//       formData.propDesc || null,
//       formData.community || null,
//       formData.nbeds || null,
//       formData.bathrooms || null,
//       formData.balcony || null,
//       formData.tenant || null,
//       formData.tenantEat || null,
//       formData.rentalPrice || null,
//       1,
//       formData.parking || null,
//       parseInt(formData.towerNumber) || null,
//       parseInt(formData.floorNumber) || null,
//       parseInt(formData.flatNumber) || null,
//       // Example value for prop_type_id, if null it will be handled
//       // Add more values as needed
//     ];
  
//     // Format fieldValues for SQL: Convert null to "NULL" without quotes, and wrap other values in quotes
//     const formattedFieldValues = fieldValues
//       .map((value) => (value === null ? "NULL" : `${value}`)) // Format NULL values correctly
//       .join(","); // No parentheses in the final string
  
//     try {
//       console.log("Sending API request:", {
//         tableName,
//         fieldNames,
//         fieldValues: formattedFieldValues, // Log formatted values for debugging
//       });
  
//       // Call the API with formatted values
...
const handleInputChange = (e) => {
      ...
      setPanels((prevPanels) => {
        ...
        if (value === 3) {
          updatedPanels[1] = [
            ...
            { label: "Baths", name: "nbaths", type: "dropdown", options: bathrooms },
          ];
            // { label: "Rental Price", name: "rentalPrice", type: "text" },
  ...
  //   const selectedPropType = e.target.value;
  //   setPropType(selectedPropType);
  ...
  //   // Update panels based on the selected property type
  //   if (selectedPropType === "Villa") {
  //     setPanels((prevPanels) => {
  //       const updatedPanels = [...prevPanels];
  //       updatedPanels[1] = [
  //         { label: "Unit#", name: "unitNumber", type: "text" },
  ...
  //       return updatedPanels;
  //     });
  //   } else if (selectedPropType === "Apartment") {
  //     setPanels((prevPanels) => {
  //       const updatedPanels = [...prevPanels];
  //       updatedPanels[1] = [
  //         { label: "Tower#", name: "towerNumber", type: "text" },
...
const handleSubmit = async (e) => {
  ...
  const formattedFieldValues = fieldValues
    ...
    .join(",");
    console.log("try",formattedFieldValues);
