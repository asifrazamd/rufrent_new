...
import PostPropertiesViewClone from "./views/PostPropertiesViewClone";
...
const App = () => {
  return (
    <Routes>
      ...
      <Route path="/getAllProperties/:propertyId" element={<FullDetailCard />} />
      <Route path="/mylistings" element={<MyListingsView />} />
      <Route path="/favorites" element={<FavoritesPage />} />
      {/* <Route path="/postProperties" element={<Post />} /> */}
      <Route path="/postProperties" element={<PostPropertiesViewClone />} />
