...
export const addNewRecord = async (tableName, fieldNames, fieldValues) => { //postproperties
  try {
...
export const addRequest = async (requestData) => { // rmrequests property id, userid
  try {
...
export const displayProperties = async (currentPage, pageLimit) => {
  try {
